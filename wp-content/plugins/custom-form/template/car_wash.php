...
<script type="text/javascript">
    ...
    $(document).ready(function () {
	   ...
	   //      $('#venue-list').click(function (e) {
	   //        e.preventDefault();
	   //        // var link = $(this).attr('href');
			 //  $('.image-car').css("display", "block");
	...
	function myFunction() {
	  var x = document.getElementById("image-car");
...
<?php
	...
	if(empty($_SESSION['redeem_carwash'])){
		$session_redeem = 1;
	}
?>
<div class="container">
	<div class="row" style="margin-bottom: 15px;">
		<div>
			<h2 style="text-align: center;">Please enter in your monthly car wash code for the current month.Your code is valid the first 7 calendar days of the month</h2>
		</div>
	...
	<div class="row">
		...
		<div class="col-md-7">
			...
			<input type="hidden" name="idForm" id="idForm" value="31">
			
			<div class="form-group">
					
					<select class="form-control" name="" id="venue-list"  style="background:black;color: white;background-image: none;" onclick="myFunction();">
			...
			<div class="image-car" id="image-car">
				<img class="" src="<?php echo get_template_directory_uri(); ?>/images/venue-car-list.png">
			</div>
			...
			<div class="col-md-5">
				<div class="form-group">
					<select class="form-control" name="monthly_pass" id="monthly_pass" data-bvalidator="required" data-bvalidator-msg="Please select your current month" style="background: black;color: white;background-image: none;">
				...
				<div class="form-group">
                    <center>
                        <label style="font-weight:bold;margin-bottom:5px;">Enter your rego/plate number</label>
                    </center>
                    <input class="form-control" data-bvalidator="required" data-bvalidator-msg="Please enter your rego/plate number" name='number_plat' type='text' value='' style="width:100%;text-align: center;" placeholder="Enter your rego/plate number" />
                    
                </div>

				<div class="form-group">
                    <center>
                        <label style="font-weight:bold;margin-bottom:5px;">Please enter in your monthly car wash code for the current month.Your code is valid the first 7 calendar days of the month</label>
                    </center>
                    <input class="form-control" data-bvalidator="required" data-bvalidator-msg="Please enter your unique code car wash" name='unique_code' type='text' value='' style="width:100%;text-align: center;" placeholder="Enter your 10 digits code" />
